...
$inputNomeEvento=$_POST['inputNomeEvento'];
$inputEvento=$_POST['inputEvento'];
...
if ($res1){
	$sql = " INSERT INTO eventoe"
	." (codigo_evento ,tipo_evento,nome_evento,data_evento,cep_evento,rua_evento,horario_evento)"
	." VALUES ('$inputCodigo', '$inputTipo', '$inputNomeEvento', '$inputEvento',
	'$inputCEP', '$inputRua', '$inputHoraEvento')";
...
<form method="POST" action="cadastro_eventos.html">
	<!DOCTYPE html>
	<html>
	<head>
		<meta charset="UTF-8">
