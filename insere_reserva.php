...
$inputPreco=$_POST['tipoIngresso'];
$inputCodigo=$_POST['inputCodigo'];
$inputNMesa=$_POST['inputNMesa'];
$inputCodEvento=$_POST['inputCodEvento'];
$inputIngresso=$_POST['inputIngresso'];

$res1 = mysql_connect("localhost", "root", "12345678");
if ($res1){
	$sql = " INSERT INTO reservae"
	." (codigo_reserva,ingressoTipo_reserva,preco_reserva,numeroMesa_reserva,codEvento_reserva,limiteIngresso_reserva)"
	." VALUES ('$inputTipo', '$tipoIngresso', '$inputCodigo', '$inputNMesa',
	'$inputCodEvento', '$inputIngresso')";
...
<form method="POST" action="cadastro_de_evento.php">
	<!DOCTYPE html>
	<html>
	<head>
		<meta charset="UTF-8">
